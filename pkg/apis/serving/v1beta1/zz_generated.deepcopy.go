...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LoggerStrategy) DeepCopyInto(out *LoggerStrategy) {
	*out = *in
	if in.Location != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoggerStrategy.
func (in *LoggerStrategy) DeepCopy() *LoggerStrategy {
	if in == nil {
		return nil
	}
	out := new(LoggerStrategy)
