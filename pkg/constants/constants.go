...
var (
	...
	LoggerStrategyMethodInternalAnnotationKey        = InferenceServiceInternalAnnotationsPrefix + "/logger-strategy-method"
	LoggerStrategyLocationInternalAnnotationKey      = InferenceServiceInternalAnnotationsPrefix + "/logger-strategy-location"
